...
{
    public partial class PingResponse : UCMBase
    {
        public uint Timestamp;

        public PingResponse() : base(enumEventType.PingResponse)
        {
        }

        public PingResponse(byte[] Value, int OffsetIndex) : base(Value, OffsetIndex)
        {
