...
{
    public partial class StreamBegin : UCMBase
    {
        public uint StreamID;

        public StreamBegin() : base(enumEventType.StreamBegin)
        {
        }

        public StreamBegin(byte[] Value, int OffsetIndex) : base(Value, OffsetIndex)
        {
